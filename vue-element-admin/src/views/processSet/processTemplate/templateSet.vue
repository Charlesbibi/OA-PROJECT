        ...
        <el-form ref="flashPromotionForm" label-width="150px" size="small" style="padding-right: 40px;">
          <el-form-item label="审批类型">
            <el-select v-model="processTemplate.processTypeId" placeholder="请选择审批类型">
              <el-option v-for="item in processTypeList" :label="item.name" :key="item.id" :value="item.id"></el-option>
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="审批图标">
            <el-select v-model="processTemplate.iconUrl" placeholder="请选择审批图标">
              <el-option v-for="item in iconUrlList" :label="item.iconUrl" :key="item.id" :value="item.iconUrl">
