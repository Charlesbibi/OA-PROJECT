    ...
    <div class="app-container">
      ...
      <div class="tools-div">
        <el-button type="success" icon="el-icon-plus" size="mini" @click="add()" 
                    :disabled="$hasBP('bnt.sysMenu.add')  === false">添 加</el-button>
      </div>
      <el-table
        :data="sysMenuList"
        ...
        <el-table-column label="操作" width="180" align="center" fixed="right">
          <template slot-scope="scope">
            <el-button type="success" icon="el-icon-plus" size="mini" @click="add(scope.row)" title="添加下级节点"
            ...
            <el-button type="danger" icon="el-icon-delete" size="mini" @click="removeDataById(scope.row)" title="删除" 
                        :disabled="(scope.row.children!=undefined && scope.row.children.size!=0) || $hasBP('bnt.sysMenu.remove')==false"/>
          </template>
        </el-table-column>
      </el-table>
